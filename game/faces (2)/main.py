...
def load_scene(screen):
    ...
    background_image = pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\kbtu.png").convert()
    background_image = pygame.transform.scale(background_image, (800,600))

    player_image = pygame.transform.scale(pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\player.png"), (32, 64))
    player_rect = player_image.get_rect(center=(WIDTH // 2, HEIGHT // 2))

    albert_image = pygame.transform.scale(pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\npcs\albert.png"), (32, 64))
    albert_rect = albert_image.get_rect(center=(200, 300))

    aknur_image = pygame.transform.scale(pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\npcs\aknur.png"), (32, 64))
    aknur_rect = aknur_image.get_rect(center=(740, 400))

    left_image = pygame.transform.scale(pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\left.png"), (20, 20))
    left_rect = left_image.get_rect(center=(200 + albert_rect.width, 320))

    right_image = pygame.transform.scale(pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\right.png"), (20, 20))
    right_rect = right_image.get_rect(center=(730 - aknur_rect.width, 420))

    text_box_image = pygame.transform.scale(pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\text_box.png"),(500,170))
...
#13
    ...
    while running:
        ...
        if player_rect.colliderect(right_rect):
            ...
            font_speaker = pygame.font.SysFont(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\fonts\lion_king.ttf", 36)
