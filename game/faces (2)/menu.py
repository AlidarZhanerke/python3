...
try:
    ...
    print("Hello world")
try:
    mainScene = importlib.import_module("fish")
except:
    print("Hello world")    
...
background_image = pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\backmenu.png").convert()
...
# Шрифты
pixel_font = pygame.font.Font(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\fonts\PressStart2P.ttf", 20)  # Здесь указывается путь к файлу шрифта и его размер

font = pygame.font.Font(None, 36)
# Загрузка и воспроизведение музыки
pygame.mixer.music.load(r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\music\piala.mp3")
...
def main_menu():
    while True:
        ...
        # Рисуем кнопки
        draw_button_texture(screen, r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\texturebutton.png", 300, 200, 200, 50, "Start", BLACK)
        draw_button_texture(screen, r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\texturebutton.png", 300, 300, 200, 50, "Quit", BLACK)
        draw_button_texture(screen, r"C:\Users\z_ali\Desktop\labs_pp2\faces (2)\images\texturebutton.png", 300, 400, 200, 50, "Settings", BLACK)
