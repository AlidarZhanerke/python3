...
car_Enemy = pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\redcar.png')
car_Own = pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\greencar.png')
bg = pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\AnimatedStreet.png")
...
class coin_generation(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.img = pygame.transform.scale(pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\coin.png'), (40,40))
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\blucar.png'), (110, 110))
...
class enemyMovement(pygame.sprite.Sprite):
        def __init__(self):
            super().__init__()
            self.car = pygame.transform.scale(pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\greencar.png'), (45, 90))
            self.rect = self.car.get_rect()
...
while 1:
    ...
    if pygame.sprite.spritecollideany(current_Own, sprite_Enemy):
        pygame.mixer.Sound(r'C:\Users\z_ali\Desktop\labs_pp2\lab8\racer\Racercar_crash.mp3').play()
        time.sleep(0.7)
