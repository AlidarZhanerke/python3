...
car_Enemy = pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab9\redcar.png')
car_Own = pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab9\greencar.png')
bg = pygame.image.load(r"C:\Users\z_ali\Desktop\labs_pp2\lab9\AnimatedStreet.png")
...
class coin_generation(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.img = pygame.transform.scale(pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab9\coin.png'), (40,40))
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab9\blucar.png'), (110, 110))
...
class enemyMovement(pygame.sprite.Sprite):
        def __init__(self):
            super().__init__()
            self.car = pygame.transform.scale(pygame.image.load(r'C:\Users\z_ali\Desktop\labs_pp2\lab9\greencar.png'), (45, 90))
            self.rect = self.car.get_rect()
...
while 1:
    ...
    if pygame.sprite.spritecollideany(current_Own, sprite_Enemy):
        pygame.mixer.Sound(r'C:\Users\z_ali\Desktop\labs_pp2\lab9\catch.mp3').play()
        time.sleep(0.7)
